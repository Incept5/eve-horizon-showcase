    ...
    <div className="min-h-screen">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <div className="rounded-xl border border-(--color-border) bg-(--color-surface-2) overflow-hidden">
            ...
            <pre className="p-4 overflow-x-auto">
              <code className="text-sm font-mono text-(--color-accent)">{'npm install -g @eve-horizon/cli\nmkdir my-project && cd my-project\neve skills install https://github.com/eve-horizon/eve-skillpacks\nclaude'}</code>
            </pre>
            <div className="px-4 pb-4 text-xs text-(--color-text-3)">
              Then run: <code className="bg-(--color-surface-3) px-1 py-0.5 rounded">/eve-bootstrap</code>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-(--color-border) bg-(--color-surface-2) overflow-hidden">
            ...
            <div className="px-4 pb-4 text-xs text-(--color-text-3)">
              Agent installs skills then finds and runs skill "eve-bootstrap".
            </div>
          </div>
        </div>
      ...
      <footer className="border-t border-(--color-border) py-8 text-center text-sm text-(--color-text-3)">
        <div>
          ...
          <a
            href="https://github.com/eve-horizon"
